...
// }
// ...
// builder.Services.AddTransient<ISubDomainACommands, SubDomainACommands>(); // utilizes Db Contexts
// builder.Services.Singleton<ISubDomainBQueries, SubDomainBQueries>();
// ```
